...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const currentLoginStorage = await AsyncStorage.getItem(dataKey)
    const currentLogin = JSON.parse(currentLoginStorage) || []
    const loginData = [...currentLogin, newLoginData]
